...
if pygame:
    ...
    while True:
        ...
        for i in range(0, len(data)):
            ...
            # Pygame draw body
            pygame.draw.circle(surface, (random.triangular(0,125,255),random.triangular(0,125,255),random.triangular(0,125,255)), (int(data[i][0]*640/200), int(data[i][1]*640/100)), 3 ,0)
